# student-record
A student record form that takes user data from the user and saves to a local database and allows you to view all the user information from the database.<br>
...
The entire program was coded in PHP.
